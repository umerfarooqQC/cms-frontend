...
const TemplateListModal = ({
  ...
  const ListItemSection = ({ name, createdBy, id, template_downloads }) => {
    return (
      <ListItem sx={{ marginBlock: "10px" }}>
        ...
        <ListItemText
          ...
          secondary={`Downloads: ${template_downloads}`}
        />
        <ListItemSecondaryAction>
          <IconButton
            size="small"
          ...
          <IconButton
            size="small"
            color="info"
            onClick={() => handleEditTemplate(id, name)}
          >
            <Edit />
          </IconButton>
          <IconButton
            size="small"
            color="error"
            onClick={() => handleConfirmationOpener(id, name)}
          >
            <Delete />
          </IconButton>
        </ListItemSecondaryAction>
                ...
                <List sx={{ width: "100%", bgcolor: "background.paper" }}>
                  {data?.map((value, index) => (
                    <ListItemSection
                      ...
                      template_downloads={value?.template_downloads}
                    />
                  ))}
                </List>
              ) : (
